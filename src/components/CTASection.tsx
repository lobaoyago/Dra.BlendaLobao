  ...
  return <section className="py-20 bg-gradient-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-10 font-light">Agende sua avaliação e descubra como eu posso te ajudar a transformar a sua vida</p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="secondary" size="lg" asChild className="group shadow-xl hover:shadow-2xl">
            ...
            <Button variant="accent" size="lg" asChild className="group shadow-xl hover:shadow-2xl">
